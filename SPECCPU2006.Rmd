...
# do the fit
        fit = nls(coredata ~ 20*2^((datedata - tzero)/tau), start=list(tzero=tzero,tau=tau))
...
However, there are more factors to consider to explain the entire observed increase, given `r tauoverall/365` years oberved for overall doubling is much smaller than `r 1./(1/taucores + 1/taufit)/365` years calculated from the core and MHz contributions. 